<div>
    ...
    <div class="bg-inherit">
        <div class="bg-white rounded-lg shadow-lg w-100 p-6 m-4 flex flex-col pl-10">
            <h4 class="text-left text-4xl font-semibold mb-2">Sampah Yang Perlu Di Ambil </h4>
                        ...
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="border border-gray-300 px-4 py-2">
                                <div class="flex justify-center">
                                    <a href="/petugas/sampah/ambil/{{ $sampah->id }}" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-1 px-3 rounded text-sm">
                                        Ambil
                                    </a>
                                </div>
                            </td>
