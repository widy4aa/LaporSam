<div>
    ...
    <div class="container mx-auto p-6 bg-inherit">
        <div class="bg-white shadow-md rounded-lg p-4 flex justify-between items-center max-w-4xl mx-auto">
            <div class="w-full">
            @if (!$isEditing)
                    <h1 class="text-2xl font-bold text-gray-800 mb-4">Detail Client</h1>
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-700">Kecamatan: <span class="text-gray-500">{{$client['kecamatan']}}</span></p>
                        <p class="text-lg font-semibold text-gray-700">Alamat: <span class="text-gray-500">{{$client['alamat_lengkap']}}<span></p>
                        <p class="text-lg font-semibold text-gray-700">Point: <span class="text-gray-500">{{$client['point']}}</span></p>
                    </div>
                ...
                <div class="w-1/3 flex justify-center items-center">
                    <img src="/storage/{{$client['link_gambar']}}" alt="Profile Picture"
